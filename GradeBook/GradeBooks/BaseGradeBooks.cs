    ...
    public class BaseGradeBook
    {
        ...
        public void AddStudents(Students student)
        {
            if (string.IsNullOrEmpty(student.Name))
                ...
                throw new ArgumentException("A students name is required");
        ...
        public void AddGrade(string name, double score)
        {
            ...
            {
                throw new ArgumentOutOfRangeException("a student name is regired");

            }
            var student = Students.FirstOrDefault(s => s.Name == name);
            if (student == null)
            {
                Console.WriteLine($"The student {name} was not found");
                return;
            }
        ...
        public void RemoveGrade(string name, double score)
        {
            if (string.IsNullOrEmpty(name))
                ...
                throw new ArgumentOutOfRangeException("A student name is reqired!");
            var student = Students.FirstOrDefault(student => student.Name == name);
            if (student == null)
            {
                Console.WriteLine($"Student name is reqired");
                return;
            }
            if (!student.Grades.Contains(score))
            {
                Console.WriteLine($"a Student {score} was not found");
                return;
            }
            student.RemoveGrades(score);
        }
